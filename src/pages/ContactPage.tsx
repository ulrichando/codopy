...
const ContactPage = () => {
  ...
  return (
    <motion.div
      className="contact relative w-screen h-screen overflow-hidden"
    ...
    >
      ...
      <div className="absolute right-1/3 top-1/4 transform -translate-y-full translate-x-1/2">
        <div className="top-20 left-10">
          <h1 className="text-4xl md:text-8xl font-bold">Get In Touch.</h1>
          <div className="flex">
      ...
      {/* Main Content */}
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/4 w-full max-w-6xl p-4">
          ...
          <div className="flex flex-col lg:flex-row items-center">
            ...
            <div className="lg:w-1/2 p-8 flex justify-center">
              ...
              >
                ...
                {/* All the SVG elements remain the same */}
              </svg>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <input
                      ...
                      value={name}
                      onChange={(e) => setName(e.target.value)}
                      className="w-full px-4 py-3 rounded-lg bg-gray-50 dark:bg-gray-800 border-0 focus:ring-2 focus:ring-blue-500 dark:text-white"
                      required
                    />
                  </div>
                  ...
                  <div>
                    <textarea
                      ...
                      onChange={(e) => setMessage(e.target.value)}
                      rows={4}
                      className="w-full px-4 py-3 rounded-lg bg-gray-50 dark:bg-gray-800 border-0 focus:ring-2 focus:ring-blue-500 resize-none dark:text-white"
                      required
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-black dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-200 text-white dark:text-black px-4 py-3 rounded-lg flex items-center justify-center space-x-2 transition-colors"
                  >
                    {loading ? (
