    ...
    <div className={`bg-white ${blurEffect ? "overflow-hidden" : ""}`}>
      ...
      >
        ...
        >
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-[#000000e2]  px-6 py-6 sm:max-w-5xl sm:ring-1 sm:ring-gray-900/10 backdrop-blur-md backdrop-filter ">
